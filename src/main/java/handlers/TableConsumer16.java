// This source code was generated by TabbyXL (http://tabbydoc.github.io) from Rule16
package handlers;
...
public class TableConsumer16 implements TableConsumer {
    ...
    public void accept(CTable table) {
        ...
        while (cIterator.hasNext()) {
            ...
            if ((c.getStyle().getFgColor() != null) && (c.getStyle().getFgColor().equals("#e7e6e6")) && (!c.isBlank())) {
                c.setTag("DATA");
            }
        }
    }
