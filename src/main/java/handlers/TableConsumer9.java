// This source code was generated by TabbyXL (http://tabbydoc.github.io) from Rule9
package handlers;
...
public class TableConsumer9 implements TableConsumer {
    ...
    public void accept(CTable table) {
        ...
        while (cIterator.hasNext()) {
            ...
            if ((c.getStyle().getFgColor() != null) && (c.getStyle().getFgColor().equals("#ffd965")) && (!c.isBlank())) {
                c.setTag("STUB2");
            }
        }
    }
