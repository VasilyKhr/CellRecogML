// This source code was generated by TabbyXL (http://tabbydoc.github.io) from Rule15
package handlers;
...
public class TableConsumer15 implements TableConsumer {
    ...
    public void accept(CTable table) {
        ...
        while (cIterator.hasNext()) {
            ...
            if ((c.getStyle().getFgColor() != null) && (c.getStyle().getFgColor().equals("#70ad47")) && (!c.isBlank())) {
                c.setTag("CURRENCY");
            }
        }
    }
