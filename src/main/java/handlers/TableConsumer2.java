// This source code was generated by TabbyXL (http://tabbydoc.github.io) from Rule2
package handlers;
...
public class TableConsumer2 implements TableConsumer {
    ...
    public void accept(CTable table) {
        ...
        while (cIterator.hasNext()) {
            ...
            if ((c.getStyle().getFgColor() != null) && (c.getStyle().getFgColor().equals("#fff2cb"))) {
