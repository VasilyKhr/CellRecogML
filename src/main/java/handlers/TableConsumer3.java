// This source code was generated by TabbyXL (http://tabbydoc.github.io) from Rule3
package handlers;
...
public class TableConsumer3 implements TableConsumer {
    ...
    public void accept(CTable table) {
        ...
        while (cIterator.hasNext()) {
            ...
            if ((c.getStyle().getFgColor() != null) && (c.getStyle().getFgColor().equals("#fff2cb")) && (!c.isBlank())) {
                c.setTag("STUB");
            }
        }
    }
