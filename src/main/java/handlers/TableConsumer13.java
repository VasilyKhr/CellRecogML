// This source code was generated by TabbyXL (http://tabbydoc.github.io) from Rule13
package handlers;
...
public class TableConsumer13 implements TableConsumer {
    ...
    public void accept(CTable table) {
        ...
        while (cIterator.hasNext()) {
            ...
            if ((c.getStyle().getFgColor() != null) && (c.getStyle().getFgColor().equals("#fbe4d5")) && (!c.isBlank())) {
                c.setTag("HEAD");
            }
        }
    }
