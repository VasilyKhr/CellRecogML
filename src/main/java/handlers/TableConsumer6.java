// This source code was generated by TabbyXL (http://tabbydoc.github.io) from Rule6
package handlers;
...
public class TableConsumer6 implements TableConsumer {
    ...
    public void accept(CTable table) {
        ...
        while (cIterator.hasNext()) {
            ...
            if ((c.getStyle().getFgColor() != null) && (c.getStyle().getFgColor().equals("#ffe598")) && (!c.isBlank())) {
                c.setTag("STUB1");
            }
        }
    }
